package com.chensoul.monolith.infrastructure.webmvc.advices;

import com.chensoul.monolith.common.constants.Headers;
...
public class ResponseHeaderAdvice implements ResponseBodyAdvice<Object> {
	...
	private static void addResponseTimeHeader(
		...
		if (startTime != null) {
			response.getHeaders().add(Headers.RESPONSE_TIME_HEADER, fromTimeToString(startTime));
		}
	}
